(() => {
  ...
  // 5. Kontaktformular (FIXED: Sendet an Cloudflare Function /api/send)
  ...
  if (form) {
    form.addEventListener('submit', async (e) => {
      ...
      try {
        // WICHTIG: Hier rufen wir jetzt DEINE Function auf, nicht Resend direkt!
        // Das löst das CORS Problem.
  ...
  // 6. Interaktive Effekte
  
  // A) Glass Specular Highlight
